...
from hgicookiemonster.shared.common import study_with_id_in_latest_irods_update


def _can_enrich(cookie: Cookie, context: HgiContext) -> bool:
    return cookie.enrichments[-1].source != IRODS_ENRICHMENT and study_with_id_in_latest_irods_update("3543", cookie)
