...
CREATION_OBSERVED_AND_INCORRECT_MANUAL_QC = "creation_observed_and_incorrect_manual_qc"
CREATION_OBSERVED_AND_INCORRECT_MANUAL_QC_RULE_PRIORITY = NOT_CRAM_RULE_PRIORITY + 1

INCORRECT_MANUAL_QC_VALUE = 0
...
_rule = Rule(_matches, _action, CREATION_OBSERVED_AND_INCORRECT_MANUAL_QC,
             CREATION_OBSERVED_AND_INCORRECT_MANUAL_QC_RULE_PRIORITY)
register(_rule)
